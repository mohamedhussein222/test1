{assign var="title" value="Your Deposits"}
...
<tr>
 <th colspan=3 align=center><b>{$plans[plans].name}</b></th>
</tr><tr>
 <th class=inheader>Plan</td>
 <th class=inheader width=200>Amount Spent ({$currency_sign})</td>
 <th class=inheader width=100 nowrap><nobr>{$plans[plans].period} Profit (%)</nobr></td>
</tr>
