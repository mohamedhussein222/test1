{assign var="title" value="Earnings History"}
...
<input type=hidden name=page value={$current_page}>
 <td>
   <select name=type class=inpts style="width:80%;" onchange="document.opts.submit();">
...
<br><img src=images/q.gif width=1 height=4><br>
   <select name=ec class=inpts style="width:80%;">
...
<tr>
 ...
 <td class=item width=200 align=right><b>{$currency_sign} {$trans[trans].actual_amount}</b> <img src="images/{$trans[trans].ec}.gif" align=absmiddle hspace=1 height=17></td>
